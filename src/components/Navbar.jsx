...
function Navbar(props){
    ...
    return(
        <div className="flex justify-between items-center w-11/12 max-w-[1160px] py-4 mx-auto">
            <Link to="/login"> <p className="bg-yellow-500 text-white py-2 px-4 rounded-[8px] border border-richblack-700  hover:scale-105 transition-transform font-bold text-xl">Basic Authentication Page</p></Link>
            <nav>
